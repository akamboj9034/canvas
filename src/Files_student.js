...
export class Files_student extends Component{
    ...
    componentDidMount(){
        ...
        let id= {course_id};
        axios.get(`http://localhost:3001/files_student/${id.course_id}`,{headers: {'Authorization': localStorage.getItem('token')}})
    ...
    render(){
        ...
        <div class="side_navigation">
            ...
            <div class="row">
                ...
                <br/>
                <br/>
                <h3>All files for courses enrolled</h3>
<table class="table">
                            <thead>
                                <tr>
                                    <th>Course ID</th>
